#include<iostream.h>                                                                                             //  all header files included
#include<conio.h>
#include<fstream.h>
#include<string.h>
#include<stdio.h>
...
struct date                                                                                                                       // structure defination
{int mm,dd,yy;};
...
{cout.setf(ios::fixed);
 ...
 clrscr();
	...
	gotoxy(35,17);
	cout<<"\n\n\n\n\n\n\t !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !!\n";
cout<<"\t !!                            SUPER  MARKETING                          !!\n";
cout<<"\t !!                                  (BILLING)                                       !!\n";
cout<<"\t !!                                                          !!\n";
cout<<"\t !!                A  PROJECT  BY : Sanyam Swami             !!\n";
cout<<"\t !!                    CLASS      : 12 (Science)             !!\n";
cout<<"\t !!                   ROLL NO.    : 25                       !!\n";
cout<<"\t !!                    SCHOOL     : K V N.D.A                !!\n";
cout<<"\t !!                                                          !!\n";
cout<<"\t !!                                                          !!\n";
cout<<"\t !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !! !!\n";
